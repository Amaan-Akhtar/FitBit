...
for col in outlier_columns:
    for label in df["label"].unique():
        ...
        oultiers_removed_df.loc[(oultiers_removed_df["label"]==label),col] = dataset[col]
        
        n_outliers = len(dataset)-len(oultiers_removed_df[col].dropna()) 
        print(f"Removed {n_outliers} from {col} for {label}")
        
oultiers_removed_df.info()
# --------------------------------------------------------------
# Export new dataframe
# --------------------------------------------------------------

oultiers_removed_df.to_pickle("../../data/interim/02_outlier_removed_chauvenets.pkl")