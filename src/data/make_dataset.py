import pandas as pd
from glob import glob # list all files based on extensions
...
# label = f.split("-")[1]
# category = f.split("-")[2].rstrip("1234567890")
...
# pd.to_datetime(df["time (01:00)"]).dt.day_of_year
...
temp = pd.read_pickle("../../data/interim/01_data_processed.pkl")
