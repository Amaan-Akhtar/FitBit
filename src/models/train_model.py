...
print("Basic features: ",len(basic_features)," ",basic_features)
print("Square features: ",len(square_features)," ",square_features)
print("PCA features: ",len(pca_features)," ",pca_features)
print("Time features: ",len(time_features)," ",time_features)
print("Frequency features: ",len(freq_features)," ",freq_features)
print("Cluster features: ",len(cluster_features)," ",cluster_features)
